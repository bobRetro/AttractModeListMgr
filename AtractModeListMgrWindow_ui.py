...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.findDupButton.sizePolicy().hasHeightForWidth())
        self.findDupButton.setSizePolicy(sizePolicy)
        self.findDupButton.setObjectName("findDupButton")
        self.gridLayout.addWidget(self.findDupButton, 0, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.expColBtn, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.uncheckedBtn, 0, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.cloneBtn, 0, 5, 1, 1)
        ...
        spacerItem = QtWidgets.QSpacerItem(900, 0, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem, 2, 1, 1, 7)
        ...
        self.gridLayout.addWidget(self.treeWidget, 5, 0, 1, 11)
